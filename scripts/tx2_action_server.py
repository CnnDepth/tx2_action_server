...
class MoveRobot:
    def __init__(self):
        ...
        self.tm_mover = tm.TurtlebotMover(ground_z=1.0, max_angular_speed=0.2, trajectory_type='line')
    ...
    def execute( self, goal ):
        ...
        local_target_x, local_target_y = pose.pose.position.x, pose.pose.position.y
        ...
        self.tm_mover.move_to( global_x_corrected, global_y_corrected )
